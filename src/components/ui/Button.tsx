...
interface Props
  extends ComponentProps<'button'>,
    Omit<VariantProps<typeof styles>, 'disabled' | 'icon' | 'iconPlacement'>,
    ButtonProps {}

const styles = cva(`${css.transition} rounded-md font-semibold focus:outline-none focus:ring-2 focus:ring-offset-1`, {
  variants: {
    intent: {
